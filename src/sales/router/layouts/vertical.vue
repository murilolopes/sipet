<script>
import Topbar from '@sales-components/topbar'
import SideBar from '@sales-components/side-bar'
import Rightsidebar from '@sales-components/right-sidebar'
import Footer from '@sales-components/footer'
