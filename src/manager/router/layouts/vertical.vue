<script>
import { layoutComputed } from '@manager-state/helpers'
import Topbar from '@manager-components/topbar'
import SideBar from '@manager-components/side-bar'
import Rightsidebar from '@manager-components/right-sidebar'
import Footer from '@manager-components/footer'
