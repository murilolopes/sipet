...
import { employeeMethods, employeeGetters } from '@manager-state/helpers'
 
export default {
  page: {
    title: 'Funcionários',
    meta: [{ name: 'funcionarios', content: appConfig.description }],
  },
  ...
  <Layout>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            <h4 class="header-title mt-0 mb-1">Funcionários</h4>
              ...
              <div class="col">
                <div class="dataTables_paginate paging_simple_numbers float-right">
                  <ul class="pagination pagination-rounded mb-0">
                    <b-pagination v-model="currentPage" :total-rows="employees.length" :per-page="perPage"></b-pagination>
                  </ul>
                </div>
              </div>
            </div>
